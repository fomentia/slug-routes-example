defmodule MySiteWeb.CommentControllerTest do
  use MySiteWeb.ConnCase

  alias MySite.Blog

  @create_attrs %{author_name: "some author_name", body: "some body", title: "some title"}
  ...
  describe "update comment" do
    ...
    test "redirects when data is valid", %{conn: conn, comment: comment} do
      ...
      assert html_response(conn, 200) =~ "some updated author_name"
    end
